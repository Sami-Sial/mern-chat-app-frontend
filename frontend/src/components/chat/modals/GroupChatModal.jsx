...
const GroupChatModal = ({ modalShow }) => {
  ...
  return (
    ...
    >
      <DialogTitle sx={{ m: 0, p: 2, textAlign: "center", fontWeight: 600, fontSize: "1.2rem" }}>
        Create Group Chat
      </DialogTitle>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          <h5 style={{ margin: 0, color: "#333", fontSize: "13px" }}>Added Users</h5>
          <div style={{
            display: "flex", 
            gap: "8px", 
            overflowX: "auto", 
            ...
            {selectedUsers.length > 0 ? (
              selectedUsers.map((user) => (
                ...
                >
                  {user.name}
                  <CloseIcon
                    style={{ marginLeft: "6px", fontSize: "16px", cursor: "pointer" }}
                    onClick={() => removeUserFromGroup(user)}
                  />
                </div>
              ))
            ) : (
              <p style={{ fontSize: "13px", color: "#888", margin: 0 }}>No users added yet</p>
            )}
          </div>
        </div>
      ...
      >
        <h5 style={{ marginBottom: "16px", color: "#333", fontSize: "14px" }}>
